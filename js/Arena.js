Arena = function(game) {
    ...
    materialGround.diffuseTexture = new BABYLON.Texture("assets/images/corner.jpg", scene);
    ...
    materialWall.diffuseTexture = new BABYLON.Texture("assets/images/pillier.jpg", scene);
